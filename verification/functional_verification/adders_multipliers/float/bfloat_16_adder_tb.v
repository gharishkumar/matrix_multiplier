...
module bfloat_16_adder_tb;
  ...
  initial begin
    ...
    #10;
    input_a = 16'h3FC0; // 1.5
    input_b = 16'h4020; // 2.5
    input_a_stb = 1;
    input_b_stb = 1;
    ...
    #10;
    input_a = 16'hC050; // -3.25
    input_b = 16'h3FE0; // 1.75
    input_a_stb = 1;
    input_b_stb = 1;
