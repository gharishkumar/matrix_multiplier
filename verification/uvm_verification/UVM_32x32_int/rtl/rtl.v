...
module mat_wrapper(
    ...
    input      [31:0]  b21,
    input      [31:0]  b22,
    output reg [64:0] result_row00,
    output reg [64:0] result_row01,
    output reg [64:0] result_row10,
    output reg [64:0] result_row11,
    output reg        valid
    );
   ...
   wire [64:0] result_row00_sys;
   wire [64:0] result_row01_sys;
   wire [64:0] result_row10_sys;
   wire [64:0] result_row11_sys;
   ...
   reg [32:0] b_reg;
    ...
    wire valid_op;
        ...
        systolic_2x2 inst_systolic_2x2 (
            .clk          (clk),
            .rst          (rst),
            .load_in      (load_in_sys),
            ...
            .result_row00 (result_row00_sys[63:0]),
            .result_row01 (result_row01_sys[63:0]),
            .result_row10 (result_row10_sys[63:0]),
            .result_row11 (result_row11_sys[63:0]),
            .carry_00     (result_row00_sys[64]),
            .carry_01     (result_row01_sys[64]),
            .carry_10     (result_row10_sys[64]),
            .carry_11     (result_row11_sys[64]),
            .done         (done_sys),
            .valid_op     (valid_op)
        );
