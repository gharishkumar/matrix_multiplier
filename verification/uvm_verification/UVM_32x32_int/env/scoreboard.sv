...
class scoreboard extends uvm_scoreboard;
		...
		forever begin
			...
			@(drv_trigger);
				...
				drv_data = drv_to_sb.pop_front();
						if (col_1_mul(mon_data.a11,mon_data.b11,mon_data.a12,mon_data.b21) == drv_data.result_row00  ) begin
	...
	virtual function int col_1_mul(bit [31:0] data1, bit [31:0] data2, bit [31:0] data3, bit [31:0] data4);
