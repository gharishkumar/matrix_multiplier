...
class monitor extends uvm_monitor;
	...
	task monitor_data();
		...
		@(posedge vif.clk);
		    ...
		    itm_h.result_out    = vif.result_out;
		...
		`uvm_info(get_type_name(), $sformatf("VIFF a11 : %0d , a12 : %0d , result_row00 : %0h",vif.a11 , vif.a12 , vif.result_out), UVM_NONE)
		`uvm_info(get_type_name(), $sformatf("VIFF a21 : %0d , a22 : %0d",vif.a21 , vif.a22), UVM_NONE)
		`uvm_info(get_type_name(), $sformatf("VIFF b11 : %0d , b12 : %0d",vif.b11 , vif.b12), UVM_NONE)
		`uvm_info(get_type_name(), $sformatf("VIFF b21 : %0d , b22 : %0d",vif.b21 , vif.b22), UVM_NONE)
